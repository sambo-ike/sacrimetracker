		  ...
		  <h2>Reset Password</h2>
            <div class="card" id="individual" >
              ...
              <div class="card-header" style="display:flex;width:100%;">
                <h5 class="title" >Reporter Password Reset</h5>
              </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 pr-md-1">
                      <div class="form-group">
                        <label>Email</label>
                        <input type="email" class="form-control" placeholder="" value="" id="email">
                      </div>
                    </div>
                    <div class="col-md-6 pl-md-1">
                      <div class="form-group">
                        <label>ID Number</label>
                        <input type="text" class="form-control" placeholder="" value="" id="id_number">
                      </div>
                    </div>
                  </div>
              ...
              <div class="card-footer">
                <button type="submit" class="btn btn-fill btn-primary" onclick="reset()">Reset</button>
              </div>
...
function reset(){  
	...
	if(email!=""&&id_number!=""){   //CHECKING IF PASSWORD AND EMAIL IS NOT EMPTY
	loader.show();
    $.ajax({
        url: "classess/reset_password.php",
        cache: false,
		data:{email:email,id_number:id_number},
